    ...
    def _add_room_allocation_to_story(self, story, room_alloc):
        ...
        if students:
            ...
            for student_alloc in sorted(students, key=lambda x: x['seat_number']):
                ...
                # Format all subjects with line breaks for readability
            ...
            # Improved column widths for better subject display
            student_table = Table(student_data, colWidths=[0.6*inch, 1.4*inch, 1.0*inch, 0.5*inch, 1.0*inch, 1.5*inch])
            student_table.setStyle(TableStyle([
                ...
                ('VALIGN', (4, 1), (5, -1), 'TOP'),
                ('LEFTPADDING', (4, 1), (5, -1), 4),
                ('RIGHTPADDING', (4, 1), (5, -1), 4),
            ]))
