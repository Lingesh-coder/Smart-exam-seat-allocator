"""
Test script to verify strict adjacent seating implementation
Tests the grid calculation and strict placement rules
"""
...
def test_grid_calculation():
    """Test seat grid coordinate calculation"""
    print("=" * 60)
    ...
    # Test 60-seat room (30 benches, 8 rows × 4 columns)
    capacity = 60
...
def test_strict_placement_rules():
    """Test strict placement validation"""
    print("=" * 60)
    ...
    # Place a Math student at Seat 1 (Row 0, Col 0, Left)
...
def test_bench_layout():
    """Test room layout calculations for different capacities"""
    print("=" * 60)
...
def test_adjacent_detection():
    """Test detection of beside and across placements"""
    print("=" * 60)
    ...
    # Create a scenario with multiple same-subject students
    seat_subjects = {
        1: "Computer Science",   # Row 0, Col 0, Left
        10: "Computer Science",  # Row 1, Col 1, Right
        19: "Computer Science",  # Row 2, Col 1, Left
    }
    ...
    # Test seats that should be rejected or allowed
    test_attempts = [
        (2, "Same bench as Seat 1", False),          # Beside seat 1
        (9, "Same column as Seat 1", False),         # Across from seat 1 (Col 0)
        (17, "Same column as Seat 1", False),        # Across from seat 1 (Col 0)
        (9, "Same bench as Seat 10", False),         # Beside seat 10
        (20, "Same bench as Seat 19", False),        # Beside seat 19
        (27, "Same column as Seat 19", False),       # Across from seat 19 (Col 1)
        (3, "Same column as Seat 19", False),        # Col 1, same as seat 19
        (5, "Different column from all", True),      # Col 2, should be OK
        (7, "Different column from all", True),      # Col 3, should be OK
        (11, "Same column as Seat 19", False),       # Col 1, same as seat 19
    ]
